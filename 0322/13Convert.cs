...
// 2진수, 8 진수, 10 진수, 16 진수로 출력하기
short value = short.MaxValue ; // Int16.MaxValue
            Console.WriteLine("\n2 진수 , 8 진수 , 10 진수 , 16 진수로 출력하기");
            //
            for (int baseNum = 2; baseNum <= 16; baseNum *= 4)
                ...
                //}
            int baseNum = 2;
string s = Convert.ToString (value , baseNum ); // value 를 string 으로 변환 (2 진수로
                int i = Convert.ToInt32(s, baseNum ); // string 으로 변환된 값을 2 진수로 읽어서 int 로 다시 변환
