...
// (1) 1부터 128 까지의 숫자를 2 진수 , 8 진수 , 16 진수로 출력
Console.WriteLine("{0,5} {1,8} {2,3} {3,4}", "10 진수 ", "2 진수 ", "8 진수 ", "16 진수);
for(int i = 1; i <= 128; i++)
{
...
Convert.ToString(i , PadLeft (8, '0'),
Convert.ToString(i ,8),
Convert.ToString(i ,16));
}
#endregion
region (2) 구구단 출력
// (2) 1~9사이의 정수 n 을 읽어들여 해당하는 구구단의 n 단 출력
